...
export const ExecutionViewer = ({
  ...
  useEffect(() => {
    ...
    if (isRunning) {
      // Selected last executed phase
      const phaseToSelect = phase.toSorted((a, b) => a.startedAt! > b.startedAt! ? -1 : 1
      )[0];
    ...
    const phaseToSelect = phase.toSorted((a, b) => a.completedAt! > b.completedAt! ? -1 : 1
    )[0];
    setSelectedPhase(phaseToSelect.id)
